# LaTeX author support for the International Press journal *Communications in Information and Systems* (*CIS*)
...
For the CIS journal `cis` option must be set in a `\documentclass[]{ipart}`:
```latex
